...
ALLOWED_HOSTS = ['cryptic-falls-05698-5c33a6719738.herokuapp.com', 'localhost', '127.0.0.1']
...
# Heroku: Update database configuration from $DATABASE_URL (production only)
...
AWS_LOCATION = 'recipes'  # Store files in 'recipes' folder in S3

# Media files configuration
# Use S3 for media files if AWS credentials are configured, otherwise use local storage
